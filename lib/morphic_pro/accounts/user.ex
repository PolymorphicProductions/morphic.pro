defmodule MorphicPro.Accounts.User do
  @moduledoc false
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, MorphicPro.Repo)
  ...
  """
  def valid_password?(%MorphicPro.Accounts.User{hashed_password: hashed_password}, password)
