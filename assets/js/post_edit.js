  ...
  import("@silvia-odwyer/photon").then(photon => {
    ...
    thumUrl.addEventListener('load', (e) => {
      ...
      upload.addEventListener('load', (e) => {
        document.getElementById("post_thumb_img").value = `https://morphicpro.s3-us-west-2.amazonaws.com/posts/${uuid}/thumb.jpg`
      })
    ...
    thumUrl.send(`{"file": "/posts/${uuid}/thumb.jpg"}`)
    ...
    largeUrl.send(`{"file": "/posts/${uuid}/large.jpg"}`)
  })
}
