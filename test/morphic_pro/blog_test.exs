defmodule MorphicPro.BlogTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", draft: true, excerpt: "some excerpt", published_at: ~D[2010-04-17], published_at_local: ~D[2010-04-17], slug: "some slug", title: "some title"}
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.published_at_local == ~D[2010-04-17]
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.published_at_local == ~D[2011-05-18]
